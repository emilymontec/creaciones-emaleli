...
export function HeroBanner() {
  return (
    <section className="relative overflow-hidden rounded-modal bg-gradient-to-r from-accent-600 via-primary-600 to-secondary-600 p-6 text-white shadow-elevated sm:p-10">
      {/* Fondos decorativos */}
      ...
      <div className="relative z-10 grid grid-cols-1 gap-8 lg:grid-cols-12 lg:items-center">
        ...
        <div className="lg:col-span-8 space-y-5 text-center lg:text-left">
          ...
          <h1 className="font-display text-3xl font-extrabold leading-tight sm:text-display-md lg:text-display-lg text-white">
            ...
            <br />
            <span className="text-yellow-200 drop-shadow">hechos especialmente para ti</span>
          </h1>
        ...
        <div className="lg:col-span-4 flex justify-center">
          <div className="w-full max-w-sm rounded-card bg-white/15 p-5 backdrop-blur border border-white/25 text-white shadow-lg space-y-3">
            <div className="flex items-center gap-2 border-b border-white/20 pb-3">
              ...
              <span className="text-sm font-extrabold text-yellow-200">Oferta de Temporada</span>
            </div>
            <p className="text-xs text-white/90 leading-relaxed">
              Hasta un{" "}
              <span className="font-extrabold text-yellow-200 text-sm">40% de descuento</span>{" "}
